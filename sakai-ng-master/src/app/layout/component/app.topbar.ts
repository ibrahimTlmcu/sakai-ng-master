        ...
        <div class="layout-topbar-actions">
            ...
            <div class="layout-topbar-menu hidden lg:block">
                <div class="layout-topbar-menu-content">
                    ...
                    <button style="margin-left: 30px" type="button" class="layout-topbar-action">
                        <i class="pi pi-user-minus"> </i>
                    </button>
                    <div style="margin-left: 10px" *ngIf="username$ | async as username">
                        Hoşgeldin<br>
...
export class AppTopbar implements OnInit {
    items!: MenuItem[];
    username$!: Observable<string | null>; // Türü tanımla, başlatmayı ngOnInit'e bırak
    ...
    ngOnInit(): void {
        this.username$ = this.authService.getUsername(); // authService artık başlatılmış
    }
